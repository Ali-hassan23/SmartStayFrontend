...
<footer className="bg-white">
    ...
    <hr className="my-6 border-gray-200 sm:mx-auto dark:border-gray-700 lg:my-8" />
        ...
        <div className="md:flex md:justify-between">
          ...
          <div className="mb-6 md:mb-0">
              <Link href="/" className="flex items-center">
                  <Image src="/smartlogo.jpg" className="h-20 me-3 bg-blend-multiply w-auto" alt="FlowBite Logo" width={100} height={100} />
      ...
      <div className="sm:flex sm:items-center sm:justify-center">
          <span className="text-sm text-black sm:text-center dark:text-black">© 2023 <Link href="h/" className="hover:underline">SmartStay™</Link>. All Rights Reserved.
          </span>
