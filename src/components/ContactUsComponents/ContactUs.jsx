...
import ContactSuccessfull from './ContactSuccessfull';
...
const ContactUs = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setIsSubmitted(true); // Set the submission state to true upon successful form submission
    } catch (error) {
      console.log(error);
    }
  }
        ...
        <>
          <div className='flex flex-col items-center w-auto px-7 md:w-1/2 mt-36'>
            ...
            <p className='text-center font-medium '>
              ...
              IG: www.instagram.com/SmartStay
            </p>
          </div>
