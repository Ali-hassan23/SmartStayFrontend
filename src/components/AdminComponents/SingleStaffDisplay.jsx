...
const SingleStaffDisplay = ({ staff }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gray-400">
      {userExists ? (
        <>
          <div className="flow-root rounded-lg py-7 px-4 shadow-sm">
          ...
          <div className="flex flex-row gap-4">
            <button className="bg-blue-600 hover:bg-blue-800 text-white font-bold py-2 px-4 rounded transition duration-300">
              Edit
            </button>
            <button
