            ...
            <ul className="space-y-1 border-t border-gray-100 pt-4">
              <li>
                ...
                >
                  ...
                  <span className="invisible absolute start-full top-1/2 ml-4 -translate-y-1/2 rounded bg-gray-900 px-2 py-1.5 text-xs font-medium text-white group-hover:visible">
                    Dashboard
                  </span>
                </Link>
              </li>
              ...
              <li>
                <Link href="/admin/reservations" className="group relative flex justify-center rounded px-2 py-1.5 text-gray-500 hover:bg-gray-50 hover:text-gray-700">
                  <CalendarCheck className="h-5 w-5 opacity-75" />
                  <span className="invisible absolute start-full top-1/2 ml-4 -translate-y-1/2 rounded bg-gray-900 px-2 py-1.5 text-xs font-medium text-white group-hover:visible">
                    Reservations
                  </span>
                </Link>
              ...
              <li>
                <Link href="/admin/queries" className="group relative flex justify-center rounded px-2 py-1.5 text-gray-500 hover:bg-gray-50 hover:text-gray-700">
                  <MessageSquare className="h-5 w-5 opacity-75" />
                  <span className="invisible absolute start-full top-1/2 ml-4 -translate-y-1/2 rounded bg-gray-900 px-2 py-1.5 text-xs font-medium text-white group-hover:visible">
                    Queries
                  </span>
                </Link>
