...
const AddStaffForm = ({ onClose,token }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (error.response) {
        ...
        setError(
          "Failed to submit form. Please check your network connection."
        );
      }
    }
    onClose();
  ...
  return (
    <div
      ref={modalRef}
      onClick={closeModal}
      className="fixed inset-0 bg-black bg-opacity-70 backdrop-blur-sm flex justify-center items-center h-screen"
    >
      <div>
        ...
        <form
          ...
          className="max-w-md mx-auto border border-gray-800 text-white p-12 rounded-xl bg-gray-700"
        >
